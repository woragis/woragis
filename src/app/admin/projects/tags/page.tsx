...
export default function ProjectTagsPage() {
  const [filters, setFilters] = useState<ProjectTagFilters>({});
  ...
  const { data: tags = [], isLoading, error } = useProjectTags(filters);
  ...
  const toggleVisibility = async (tag: ProjectTag) => {
    try {
      await updateTag.mutateAsync({
        id: tag.id,
      ...
      console.error("Error updating project tag visibility:", error);
    }
  };
        ...
        <Container>
          <div className="text-center">
            <p className="text-red-600 dark:text-red-400">
              Error loading project tags: {error.message}
            </p>
          </div>
        </Container>
      </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-16">
      <Container>
        <Section>
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-800 dark:text-white"
              />
            </div>
          </div>
          ...
          {tags.length === 0 ? (
            <EmptyState
              icon={Tag}
              title="No tags found"
              description="Create your first project tag to get started"
        ...
        <Modal
          ...
          title={editingTag ? "Edit Project Tag" : "Create Project Tag"}
        >
