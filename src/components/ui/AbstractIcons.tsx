  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M12 3l4 4-4 4-4-4 4-4zm0 8l4 4-4 4-4-4 4-4zm0 8l4 4-4 4-4-4 4-4z"
      />
    </svg>
  );
};

export const ControllerIcon: React.FC<IconProps> = ({
  className = "",
  size = "md",
}) => {
  const sizeClasses = {
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M8 16h8M8 8h8m-8 4h8m-4 4v4m-4-4a4 4 0 100-8 4 4 0 000 8zm8-4a4 4 0 100-8 4 4 0 000 8z"
      />
    </svg>
  );
};

export const PowerUpIcon: React.FC<IconProps> = ({
  className = "",
  size = "md",
}) => {
  const sizeClasses = {
