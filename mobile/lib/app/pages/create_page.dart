            ...
            _buildDomainSection(
              ...
              items: [
                _CreateOption(
                  ...
                  onTap: () => context.push('/money/ideas/create'),
                ),
                _CreateOption(
                  title: 'AI Chat',
                  subtitle: 'Start an AI conversation',
                  icon: Icons.chat,
                  onTap: () => context.push('/money/ai-chats/create'),
                ),
                _CreateOption(
                  title: 'Idea Canvas',
                  subtitle: 'Visual idea mapping',
                  icon: Icons.account_tree,
                  onTap: () => context.push('/money/ideas/canvas'),
                ),
              ],
            ),
            ...
            _buildDomainSection(
              ...
              items: [
                ...
                _CreateOption(
                  ...
                  icon: Icons.code,
                  onTap: () => context.push('/frameworks/create'),
                ),
              ],
            ),
            const SizedBox(height: 24),
            ...
            _buildDomainSection(
              ...
              items: [
                _CreateOption(
                  ...
                  icon: Icons.edit,
                  onTap: () => context.push('/blog/create'),
                ),
                _CreateOption(
                  title: 'Blog Tags',
                  subtitle: 'Manage blog categories',
                  icon: Icons.label,
                  onTap: () => context.push('/blog/tags'),
                ),
              ],
            ),
            const SizedBox(height: 24),
            ...
            _buildDomainSection(
              ...
              items: [
                _CreateOption(
                  ...
                  icon: Icons.school,
                  onTap: () => context.push('/education/create'),
                ),
                _CreateOption(
                  title: 'Work Experience',
                  subtitle: 'Add professional experience',
                  icon: Icons.business,
                  onTap: () => context.push('/experience/create'),
                ),
                _CreateOption(
                  title: 'Testimonial',
                  subtitle: 'Add a client testimonial',
                  icon: Icons.star,
                  onTap: () => context.push('/testimonials/create'),
                ),
              ],
            ),
          ],
